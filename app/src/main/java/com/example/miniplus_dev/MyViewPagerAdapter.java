...
public class MyViewPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public MyViewPagerAdapter(FragmentManager fm) {
        ...
        fragments[0] = new MeasureResultTestFrag();
        fragments[1] = new MeasureResultTestFrag();
        fragments[2] = new MeasureResultTestFrag();
        fragments[3] = new MeasureResultTestFrag();
        fragments[4] = new MeasureResultTestFrag();
