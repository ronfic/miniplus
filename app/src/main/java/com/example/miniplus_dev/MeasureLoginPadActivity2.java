...
public class MeasureLoginPadActivity2 extends Activity {
        ...
        btnExit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!prevent) {
                    ...
                    if (where.equals("MeasureTestActivity")) {
                        Intent intent = new Intent(MeasureLoginPadActivity2.this, MeasureTestActivity.class);
...
*/
        ...
        try {
            ...
            if (PublicValues.userId != null && PublicValues.userId.length() > 0 && !PublicValues.userId.equals("Guest")) {
                ...
                if (where.contains("MeasureTestActivity"))
                    intent = new Intent(MeasureLoginPadActivity2.this, MeasureTestActivity.class);
                else
                    intent = new Intent(MeasureLoginPadActivity2.this, MeasureLoginPadActivity2.class);
    ...
    protected void inputValues() {
        ...
        try {
            ...
            Intent intent = new Intent(MeasureLoginPadActivity2.this, MeasureResultActivity2.class);
