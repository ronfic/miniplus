...
public class MeasureTestActivity2 extends Activity implements MeasureResultFrag.OnTimePickerSetListener {

    CRC16Modbus crc = new CRC16Modbus();

    private final String TAG = MeasureTestActivity2.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                ...
                if (startFlag == false) {
                    ...
                    Toast.makeText(MeasureTestActivity2.this, "운동종료 후 눌러주세요", Toast.LENGTH_SHORT).show();
            }
        ...
        btnSelTest[0].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!startFlag) {
                    ...
                    Toast.makeText(MeasureTestActivity2.this, "측정을 종료한 뒤 눌러주세요.", Toast.LENGTH_SHORT).show();
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mB_mcActBit8 != 0x01 || posReal < 5) {
                    Intent intent = new Intent(MeasureTestActivity2.this, MainActivity.class);
                    ...
                    Toast.makeText(MeasureTestActivity2.this, "장비를 조작하지 않은 상태로 눌러주세요.", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (mB_mcActBit8 != 0x01) {
                    if (!startFlag) {
                        ...
                        Toast.makeText(MeasureTestActivity2.this, "측정을 완료한 뒤 눌러주세요.", Toast.LENGTH_SHORT).show();
                } else
                    Toast.makeText(MeasureTestActivity2.this, "장비를 조작하지 않은 상태로 눌러주세요.", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnChangeUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mB_mcActBit8 != 0x01) {
                    if (!startFlag) {
                        Intent intent = new Intent(MeasureTestActivity2.this, MeasureLoginPadActivity2.class);
        ...
        btn_pause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder Dialog = new AlertDialog.Builder(MeasureTestActivity2.this);
        ...
        mTimeCal = new TimerTask() {
            @Override
            public void run() {
                MeasureTestActivity2.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
    ...
    private class MeasureHandler extends Handler {
        private final WeakReference<MeasureTestActivity2> measureActivity;

        private MeasureHandler(MeasureTestActivity2 activity) {
...
//end/////////////////////////////////////////////////
    ...
    private class insertWorkoutData extends AsyncTask<Void, Integer, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if(no_internet) {
                ...
                Toast.makeText(MeasureTestActivity2.this, "인터넷 연결 확인해주세요!!!", Toast.LENGTH_SHORT).show();
    ...
    protected void inputValues() {
        ...
        try {
            ...
            Intent intent = new Intent(MeasureTestActivity2.this, MeasureResultActivity2.class);
