...
public class MeasureResultActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MeasureResultActivity.this, MeasureTestActivity.class);
        ...
        btnChangeUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MeasureResultActivity.this, MeasureLoginPadActivity.class);
    ...
    private class MeasureHandler extends Handler {
        private final WeakReference<MeasureResultActivity> mActivity;

        public MeasureHandler(MeasureResultActivity activity) {
